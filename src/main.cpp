...
uint256 hashGenesisBlock("0x23b107713f5db02f8fd221edfa9a4d075a26e2224febce4366e346debd31d505");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Vetcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Vetcoin Signed Message:\n";
...
{
    // Vetcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 6400000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 240000); // Vetcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 324000; // Vetcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Vetcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Vetcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Vetcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Vetcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc84904b59ac38fbad54e1f125d39b56f6fc1be0beb1d358680cc13f95f335280");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Ft Sill Oklahoma 12/27/1990 the day I began active duty";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 6400000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ea5c5f7aa92a9ad8808e8ca2333961047dc1e28d1eac9853b9c3d881d8077e72b8d485e1014de16156d921b9fe73a32e664fc19dda010848a3424acb62ba88fe48") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1506222150;
        block.nBits    = 504365644;
        block.nNonce   = 3679976123;

        if (fTestNet)
        {
            block.nTime    = 1506222150;
            block.nNonce   = 2923191009;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbc3028d42ca2eeedbfda83bcb090115bb2bb612b360293ed53879cd8e70d37d1"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Vetcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VetcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VetcoinMiner : ProcessBlock, block not accepted");
    }
